...
<%--		Favorite Programming Language (fixed values):
		...
		Favorite Programming Language (values from model):
		<form:radiobuttons path="favoriteLanguage" items="${student.programmingLanguages}"/>

		<br /><br />
		
		Experiences in OS (fixed values):
